                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" class="form-control @error('isbn') is-invalid @enderror" name="isbn" value="{{ old('isbn', $buku->isbn) }}">
                                    @error('isbn')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col">
                                <div class="mb-2">
                                    ...
                                    <input type="number" class="form-control @error('jml_halaman') is-invalid @enderror" name="jml_halaman" value="{{ old('jml_halaman', $buku->jml_halaman) }}">
                                    @error('jml_halaman')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="date" class="form-control @error('tgl_terbit') is-invalid @enderror" name="tgl_terbit" value="{{ old('tgl_terbit', $buku->tgl_terbit) }}">
                                    @error('tgl_terbit')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="mb-2">
                            ...
                            <select name="id_penulis" class="form-control @error('id_penulis') is-invalid @enderror">
                                ...
                                @foreach ($penulis as $data)
                                    <option value="{{ $data->id }}" {{ $data->id == old('id_penulis', $buku->id_penulis) ? 'selected' : '' }}>{{ $data->nama_penulis }}</option>
                                @endforeach
                            </select>
                            @error('id_penulis')
                                <span class="invalid-feedback" role="alert">
                        ...
                        <div class="mb-2">
                            ...
                            <select name="genre[]" class="form-select select-multiple" multiple="multiple">
                                @foreach ($genre as $data)
                                    <option value="{{ $data->id }}" {{ in_array($data->id, $selectGenre) ? 'selected' : '' }}>{{ $data->nama_genre }}</option>
                                @endforeach
                            </select>
                            @error('genre')
                                <span class="invalid-feedback" role="alert">
